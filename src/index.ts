...
const TAG_RULES = [
  ...
  "Если запись явно связана с ребенком, детскими товарами, садиком, няней, детскими занятиями или другими детскими расходами, нужен тег Артур и при необходимости другие подходящие теги.",
  ...
  "Все, что явно относится к Артуру или к детским расходам вокруг него, должно получать тег Артур.",
  "Няня и садик это разные теги. Если речь о няне, babysitter или присмотре за ребенком, предпочитай тег Няня. Тег Садик используй только когда явно речь про садик или детский сад.",
